    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="no-print flex items-center gap-2">
                ...
                <x-export-menu route="portal.payments.export" />
            </div>
        </div>
    </x-slot>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($payments as $payment)
                            <tr>
                                <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ $payment->rental->room->property->property_name }} — {{ $payment->rental->room->room_number }}</td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $payment->transaction_reference ?? '—' }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">No payments recorded yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
